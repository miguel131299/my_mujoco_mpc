...
class MJSIMULATEAPI Simulate {
    public:
        ...
        // Apply UI pose perturbation to model and data
        void ApplyPosePerturbations(int flg_paused);

        // Apply UI force perturbation to model and data
        ...
        void Load(mjModel* m, mjData* d, std::string displayed_filename, bool delete_old_m_d);
